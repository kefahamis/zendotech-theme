...
class Zendotech_Hero_Banner_Widget extends \Elementor\Widget_Base
{
    ...
    {
        return 'zendotech_hero_banner';
    }
    public function get_title()
    {
        return __('Hero Banner', 'zendotech');
    }
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control('slide_image', [
            ...
            'default' => [
                'url' => 'https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?w=500&h=400&fit=crop',
            ],
        ]);
        ...
        $repeater->add_control('slide_bg_color', [
            ...
            'default' => '',
            'description' => __('Custom background color for this slide. Leave blank for default.', 'zendotech'),
        ]);
        ...
        $this->add_control('card1_title', [
            'label' => __('Title', 'zendotech'),
            'type' => \Elementor\Controls_Manager::TEXT,
            'default' => 'Marshall Speaker',
        ]);
        $this->add_control('card1_price', [
            'label' => __('Price', 'zendotech'),
            'type' => \Elementor\Controls_Manager::TEXT,
            'default' => 'Save $60',
        ]);
        $this->add_control('card1_image', [
            ...
            'type' => \Elementor\Controls_Manager::MEDIA,
            'default' => [
                'url' => 'https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=200&h=200&fit=crop',
            ],
        ]);
        ...
        $this->add_control('card2_title', [
            'label' => __('Title', 'zendotech'),
            'type' => \Elementor\Controls_Manager::TEXT,
            'default' => 'Audio-Technica LP',
        ]);
        $this->add_control('card2_price', [
            'label' => __('Price', 'zendotech'),
            'type' => \Elementor\Controls_Manager::TEXT,
            'default' => 'From $299',
        ]);
        $this->add_control('card2_image', [
            ...
            'type' => \Elementor\Controls_Manager::MEDIA,
            'default' => [
                'url' => 'https://images.unsplash.com/photo-1539375665275-f9de415ef9ac?w=200&h=200&fit=crop',
            ],
        ]);
        ...
        // Tag
        $this->add_control('slider_tag_heading', [
            'label' => __('Tag', 'zendotech'),
            'type' => \Elementor\Controls_Manager::HEADING,
        ]);

        $this->add_control('slider_tag_color', [
            'label' => __('Tag Text Color', 'zendotech'),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slide-content .tag' => 'color: {{VALUE}};',
            ],
        ]);
        ...
        $this->add_control('slider_tag_bg', [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slide-content .tag' => 'background-color: {{VALUE}};',
            ],
        ]);
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .slide-content .tag',
            ]
        );

        $this->add_control('slider_tag_border_radius', [
            'label' => __('Tag Border Radius', 'zendotech'),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%'],
            'selectors' => [
                '{{WRAPPER}} .slide-content .tag' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ]);

        // Title
        $this->add_control('slider_title_heading', [
            'label' => __('Title', 'zendotech'),
            'type' => \Elementor\Controls_Manager::HEADING,
            'separator' => 'before',
        ]);
        ...
        // Description
        $this->add_control('slider_desc_heading', [
            'label' => __('Description', 'zendotech'),
            'type' => \Elementor\Controls_Manager::HEADING,
            'separator' => 'before',
        ]);
        ...
        // Price
        $this->add_control('slider_price_heading', [
            'label' => __('Price / Starting At', 'zendotech'),
            'type' => \Elementor\Controls_Manager::HEADING,
            'separator' => 'before',
        ]);
        ...
        $this->add_control('slider_price_color', [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slide-content .price .amount, {{WRAPPER}} .slide-content .price strong' => 'color: {{VALUE}};',
            ],
        ]);

        $this->add_control('slider_price_label_color', [
            'label' => __('Label Color', 'zendotech'),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slide-content .price' => 'color: {{VALUE}};',
            ],
        ]);
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .slide-content .price .amount, {{WRAPPER}} .slide-content .price strong',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'btn_typography',
                'selector' => '{{WRAPPER}} .slide-content .btn, {{WRAPPER}} .slide-content .btn-outline',
            ]
        );
        ...
        // Primary Button
        $this->start_controls_tab('tab_btn_primary', [
            'label' => __('Primary', 'zendotech'),
        ]);
        ...
        $this->add_control('btn_primary_border', [
            'label' => __('Border Color', 'zendotech'),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slide-content .btn' => 'border-color: {{VALUE}};',
            ],
        ]);

        $this->add_control('btn_primary_hover_bg', [
            'label' => __('Hover Background Color', 'zendotech'),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->start_controls_tab('tab_btn_secondary', [
            'label' => __('Secondary', 'zendotech'),
        ]);

        $this->add_control('btn_sec_color', [
            'label' => __('Text Color', 'zendotech'),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slide-content .btn-outline' => 'color: {{VALUE}};',
            ],
        ]);

        $this->add_control('btn_sec_bg', [
            'label' => __('Background Color', 'zendotech'),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slide-content .btn-outline' => 'background-color: {{VALUE}};',
            ],
        ]);

        $this->add_control('btn_sec_border_color', [
            'label' => __('Border Color', 'zendotech'),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slide-content .btn-outline' => 'border-color: {{VALUE}};',
            ],
        ]);

        $this->add_control('btn_sec_hover_bg', [
            'label' => __('Hover Background', 'zendotech'),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slide-content .btn-outline:hover' => 'background-color: {{VALUE}};',
            ],
        ]);

        $this->add_control('btn_sec_hover_color', [
            'label' => __('Hover Text Color', 'zendotech'),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .slide-content .btn-outline:hover' => 'color: {{VALUE}}; border-color: {{VALUE}};', // Inheriting border if not set
            ],
        ]);
        ...
        $this->add_control('btn_border_radius', [
            ...
            'size_units' => ['px', '%'],
            'selectors' => [
                '{{WRAPPER}} .slide-content .btn, {{WRAPPER}} .slide-content .btn-outline' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
            'separator' => 'before',
        ]);
        ...
        // --- Side Cards Style ---
        $this->start_controls_section('section_style_side_cards', [
            'label' => __('Side Cards', 'zendotech'),
            'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            'condition' => [
                'show_side_cards' => 'yes',
        ...
        $this->add_control('side_card_overlay', [
            'label' => __('Overlay Background', 'zendotech'),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .side-card::before' => 'background-color: {{VALUE}};',
            ],
        ]);

        $this->add_control('side_card_border_radius', [
            'label' => __('Border Radius', 'zendotech'),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%'],
            'selectors' => [
                '{{WRAPPER}} .side-card' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ]);

        $this->add_control('side_card_title_heading', [
            'label' => __('Title', 'zendotech'),
            'type' => \Elementor\Controls_Manager::HEADING,
            'separator' => 'before',
        ]);

        $this->add_control('side_card_title_color', [
            'label' => __('Title Color', 'zendotech'),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .side-card h3' => 'color: {{VALUE}};',
            ],
        ]);
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Typography::get_type(),
            [
                'name' => 'side_card_title_typography',
                'selector' => '{{WRAPPER}} .side-card h3',
            ]
        );

        $this->add_control('side_card_price_heading', [
            'label' => __('Price / Discount', 'zendotech'),
            'type' => \Elementor\Controls_Manager::HEADING,
            'separator' => 'before',
        ]);

        $this->add_control('side_card_price_color', [
            'label' => __('Text Color', 'zendotech'),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .side-card .price' => 'color: {{VALUE}};',
            ],
        ]);
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Typography::get_type(),
            [
                'name' => 'side_card_price_typography',
                'selector' => '{{WRAPPER}} .side-card .price',
            ]
        );
        ...
        $this->add_control('sidebar_bg_color', [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .hero-sidebar' => 'background-color: {{VALUE}};',
            ],
        ]);
        ...
        $this->add_control('sidebar_border_radius', [
            ...
            'size_units' => ['px', '%'],
            'selectors' => [
                '{{WRAPPER}} .hero-sidebar' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ]);

        $this->add_control('sidebar_link_heading', [
            'label' => __('Links', 'zendotech'),
            'type' => \Elementor\Controls_Manager::HEADING,
            'separator' => 'before',
        ]);
        ...
        $this->add_control('sidebar_link_color', [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .hero-sidebar a' => 'color: {{VALUE}};',
            ],
        ]);
        ...
        $this->add_control('sidebar_link_hover_color', [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .hero-sidebar a:hover' => 'color: {{VALUE}};',
            ],
        ]);

        $this->add_control('sidebar_icon_color', [
            'label' => __('Icon Color', 'zendotech'),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .hero-sidebar li::before' => 'color: {{VALUE}};',
                '{{WRAPPER}} .hero-sidebar a i' => 'color: {{VALUE}};',
            ],
        ]);
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .hero-sidebar a',
            ]
        );
                ...
                <div class="hero-grid">
                            ...
                            <ul class="sidebar-menu">
                                ...
                                if (taxonomy_exists('product_cat')) {
                                    ...
                                    if (!is_wp_error($cats)) {
                                        ...
                                        // Only show View More if we have more than 9
                                        if (count($cats) > 9) {
                            ...
                            if (!empty($s['slides'])) {
                                foreach ($s['slides'] as $ms) {
                                    $slides_data[] = [
                                        ...
                                        'url' => $ms['slide_btn_url']['url'] ?? '#',
                                        'img' => $ms['slide_image']['url'] ?? 'https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?w=500&h=400&fit=crop',
                            ...
                            if (!empty($slides_data)):
                                ...
                                foreach ($slides_data as $sd):
                                    ...
                                    <div class="swiper-slide">
                                        <div class="banner-bg <?php echo esc_attr($bg_class); ?>"<?php if ($bg_style): ?> style="<?php echo $bg_style; ?>"<?php endif; ?>>
                                            <div class="banner-img-container" data-swiper-parallax="-300" data-swiper-parallax-duration="1000">
                                                <img src="<?php echo esc_url($sd['img']); ?>" alt="<?php echo esc_attr($sd['title']); ?>"
                    ...
                    <div class="side-banners">
                        <div class="side-card side-yellow">
                            <div class="sc-text">
                                <span class="sc-tag">
                                    <?php echo esc_html($s['card1_tag']); ?>
                                </span>
                                <h4>
                                    <?php echo esc_html($s['card1_title']); ?>
                                </h4>
                                <p class="sc-price">
                                    <?php echo esc_html($s['card1_price']); ?>
                                </p>
                            </div>
                            <?php if (!empty($s['card1_image']['url'])): ?>
                                <img src="<?php echo esc_url($s['card1_image']['url']); ?>"
                                    alt="<?php echo esc_attr($s['card1_title']); ?>">
                            <?php endif; ?>
                        </div>
                        <div class="side-card side-blue">
                            <div class="sc-text">
                                <span class="sc-tag">
                                    <?php echo esc_html($s['card2_tag']); ?>
                                </span>
                                <h4>
                                    <?php echo esc_html($s['card2_title']); ?>
                                </h4>
                                <p class="sc-price">
                                    <?php echo esc_html($s['card2_price']); ?>
                                </p>
                            </div>
                            <?php if (!empty($s['card2_image']['url'])): ?>
                                <img src="<?php echo esc_url($s['card2_image']['url']); ?>"
                                    alt="<?php echo esc_attr($s['card2_title']); ?>">
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
